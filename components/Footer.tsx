      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-8 max_width">
        ...
        <div className="grid grid-cols-3 gap-10">
          <div className="flex flex-col gap-2">
            ...
            <div className="text-sm text-gray-400 hover:text-yellow-400 transition-colors">Facebook</div>
            <div className="text-sm text-gray-400 hover:text-yellow-400 transition-colors">X/Twitter</div>
            <div className="text-sm text-gray-400 hover:text-yellow-400 transition-colors">Instagram</div>
          </div>

          <div className="flex flex-col gap-2">
            <h3 className="text-lg font-semibold text-primary_yellow">Legal</h3>
            <div className="text-sm text-gray-400 hover:text-yellow-400 transition-colors">Privacy Policy</div>
            <div className="text-sm text-gray-400 hover:text-yellow-400 transition-colors">Terms & Conditions</div>
          </div>

          <div className="flex flex-col gap-2">
            <h3 className="text-lg font-semibold text-primary_yellow">Contact</h3>
            <div className="text-sm text-gray-400 hover:text-yellow-400 transition-colors">Email Us</div>
            <div className="text-sm text-gray-400 hover:text-yellow-400 transition-colors">Support</div>
          </div>
        </div>
      </div>
