...
const IntroContent = () => {
  ...
  return (
    <div className="w-full">   
      ...
      >
        <div className="flex items-center text-white w-full justify-between border-b-2 fade-in-item">
        ...
        <div className="flex items-center text-primary_yellow justify-center fade-in-item">
